...
###########################################
# Original importance to decide cluster representatives
...
# Adjust column names to whole cluster:
...
df_train2 = df3.head(9600)
df_test2 = df3.tail(2400)
...
figure.savefig('feature_importance_clusterd.png', dpi = 100)
print('Done')
